...
//    TESTBOLT_SPELL(11, TestboltSpell::new),
//    FIRE_BREATH_SPELL(12, FireBreathSpell::new),
//    ICICLE_SPELL(13, IcicleSpell::new),
//    FIRECRACKER_SPELL(14, FirecrackerSpell::new),
//    SUMMON_HORSE_SPELL(15, SummonHorseSpell::new),
//    ANGEL_WING_SPELL(16, AngelWingsSpell::new),
//    SHIELD_SPELL(17, ShieldSpell::new),
//    WALL_OF_FIRE_SPELL(18, WallOfFireSpell::new),
//    WISP_SPELL(19, WispSpell::new),
//    FANG_STRIKE_SPELL(20, FangStrikeSpell::new),
//    FANG_WARD_SPELL(21, FangWardSpell::new),
//    EVASION_SPELL(22, EvasionSpell::new),
//    HEARTSTOP_SPELL(23, HeartstopSpell::new),
//    LIGHTNING_LANCE_SPELL(24, LightningLanceSpell::new),
//    LIGHTNING_BOLT_SPELL(25, LightningBoltSpell::new),
//    RAISE_DEAD_SPELL(26, RaiseDeadSpell::new),
//    WITHER_SKULL_SPELL(27, WitherSkullSpell::new),
//    GREATER_HEAL_SPELL(28, GreaterHealSpell::new),
//    CLOUD_OF_REGENERATION_SPELL(29, CloudOfRegenerationSpell::new),
//    RAY_OF_SIPHONING_SPELL(30, RayOfSiphoningSpell::new),
//    MAGIC_ARROW_SPELL(31, MagicArrowSpell::new),
//    LOB_CREEPER_SPELL(32, LobCreeperSpell::new),
//    CHAIN_CREEPER_SPELL(33, ChainCreeperSpell::new),
//    BLAZE_STORM_SPELL(34, BlazeStormSpell::new),
//    FROST_STEP_SPELL(35, FrostStepSpell::new),
//    ABYSSAL_SHROUD_SPELL(36, AbyssalShroudSpell::new),
//    FROSTBITE_SPELL(37, FrostbiteSpell::new),
//    ASCENSION_SPELL(38, AscensionSpell::new),
//    INVISIBILITY_SPELL(39, InvisibilitySpell::new),
//    BLOOD_STEP_SPELL(40, BloodStepSpell::new),
//    SUMMON_POLAR_BEAR_SPELL(41, SummonPolarBearSpell::new),
//    BLESSING_OF_LIFE_SPELL(42, BlessingOfLifeSpell::new),
//    DRAGON_BREATH_SPELL(43, DragonBreathSpell::new),
//    FORTIFY_SPELL(44, FortifySpell::new),
//    COUNTERSPELL_SPELL(45, CounterspellSpell::new),
//    SPECTRAL_HAMMER_SPELL(46, SpectralHammerSpell::new),
//    CHARGE_SPELL(47, ChargeSpell::new),
//    VOID_TENTACLES_SPELL(48, VoidTentaclesSpell::new),
//    ICE_BLOCK_SPELL(49, IceBlockSpell::new),
//    POISON_BREATH_SPELL(50, PoisonBreathSpell::new),
//    POISON_ARROW_SPELL(51, PoisonArrowSpell::new),
//    POISON_SPLASH_SPELL(52, PoisonSplashSpell::new),
//    ACID_ORB_SPELL(53, AcidOrbSpell::new),
//    SPIDER_ASPECT_SPELL(54, SpiderAspectSpell::new),
//    BLIGHT_SPELL(55, BlightSpell::new),
//    ROOT_SPELL(56, RootSpell::new),
//    BLACK_HOLE_SPELL(57, BlackHoleSpell::new),
//    BlOOD_NEEDLES_SPELL(58, BloodNeedlesSpell::new),
//    ACUPUNCTURE_SPELL(59, AcupunctureSpell::new),
//    MAGMA_BOMB_SPELL(60, MagmaBombSpell::new),
//    STARFALL_SPELL(61, StarfallSpell::new),
//    HEALING_CIRCLE_SPELL(62, HealingCircleSpell::new),
//    GUIDING_BOLT_SPELL(63, GuidingBoltSpell::new),
//    SUNBEAM_SPELL(64, SunbeamSpell::new),
//    GUST_SPELL(65, GustSpell::new),
//    CHAIN_LIGHTNING_SPELL(66, ChainLightningSpell::new),
//    DEVOUR_SPELL(67, DevourSpell::new),
//    ;
//
...
//    }
//
//    //private static final SpellType[] FIRE_SPELLS = {FIREBALL_SPELL, BURNING_DASH_SPELL, FIREBOLT_SPELL, TESTBOLT_SPELL, FIRE_BREATH_SPELL, WALL_OF_FIRE_SPELL, BLAZE_STORM_SPELL};
